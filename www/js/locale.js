tgd.locale = {
    ...
    fr: {
        ...
        loadouts_mobile: "hold",
        loadouts_desktop: "check",
        loadouts_transferred: "Articles transféré avec succès <br> Si vous aimez ce soft pensez à <a style=\"color:#3080CF; cursor:pointer;\" href=\"http://bit.ly/1Jmb4wQ\" target=\"_system\">achetez-moi une bière</a>",
        loadouts_to_transfer: " will be moved",
        loadouts_no_transfer: " will not be moved",
        loadouts_no_replacement: " will not be moved. There is no item to replace it.",
        loadouts_outofspace: " will not be moved, there is no space in ",
    ...
    de: {
        ...
        loadouts_transferred: "Gegenstände erfolgreich übertragen <br> Wenn dir diese App gefällt, vergiss nicht <a style=\"color:#3080CF; cursor:pointer;\" href=\"http://bit.ly/1Jmb4wQ\" target=\"_system\">mir ein Bier zu kaufen</a>",
