tgd.locale = {
	...
	es: {
		...
		language_pack_downloaded: "Language Pack downloaded, please refresh to see the changes",
		number_of_columns: "# de Columnas",
		vo_number_of_columns: "Posicion de Bodega",
		...
		login_authenticating: "Por favor sea paciente, iniciando sesión en Bungie",
		login_title: "Bienvenido a Tower Ghost para Destiny!",
		login_instructions: "Para empezar tendrás que acceder a su cuenta a través de Bungie.net:",
		login_help: "Por favor, espere a que la ventana se cerra. TGD han preparado su información.",
		...
		loadouts_instructions: "No hay artículos en loadout, haga clic en los articulos a añadir,",
		loadouts_instructions_contd: "para equipar.",
		loadouts_mobile: "sostener",
		loadouts_desktop: "cheque",
		loadouts_transferred: "Artículo(s) transferido con éxito <br> Si te gusta esta aplicación, recuerde <a style=\"color:#3080CF; cursor:pointer;\" href=\"http://bit.ly/1Jmb4wQ\" target=\"_system\">hacer una donación</a>",
		loadouts_to_transfer: " será trasladado",
		loadouts_no_transfer: " no será trasladado",
		loadouts_no_replacement: " no será trasladado. No hay otro para reemplazarlo.",
		loadouts_outofspace: " no será trasladado, no hay espacio en ",
		loadouts_invalidbucket: " no será trasladado, Debido a este cubo: ",
