tgd.locale = {
    en: {
        ...
        loadouts_transferred: "<strong>Item(s) transferred successfully</strong><br> If you like this app remember to <a style=\"color:#3080CF; cursor:pointer;\" id=\"donateLink\" target=\"_system\">buy me a beer</a>",
    ...
    es: {
        ...
        loadouts_transferred: "<strong>Art�culo(s) transferido con �xito</strong><br> Si te gusta esta aplicaci�n, recuerde <a style=\"color:#3080CF; cursor:pointer;\" id=\"donateLink\" target=\"_system\">hacer una donaci�n</a>",
    ...
    fr: {
        ...
        loadouts_mobile: "hold",
        loadouts_desktop: "check",
        loadouts_transferred: "<strong>Articles transféré avec succès</strong><br> Si vous aimez ce soft pensez à <a style=\"color:#3080CF; cursor:pointer;\" id=\"donateLink\" target=\"_system\">achetez-moi une bière</a>",
        loadouts_to_transfer: " will be moved",
        loadouts_no_transfer: " will not be moved",
        loadouts_no_replacement: " will not be moved. There is no item to replace it.",
        loadouts_outofspace: " will not be moved, there is no space in ",
    ...
    de: {
        ...
        unable_to_create_loadout_for_bucket: "Du kannst keine Ausrüstung mit mehr als 9 Gegenständen in diesem Platz ersellen: ",
        ...
        loadouts_transferred: "<strong>Gegenstände erfolgreich übertragen</strong><br> Wenn dir diese App gefällt, vergiss nicht <a style=\"color:#3080CF; cursor:pointer;\" id=\"donateLink\" target=\"_system\">mir ein Bier zu kaufen</a>",
