...
var $ZamTooltips = new function() {
	...
	this.isEnabled = true;
	this.enabled = function(){ return this.isEnabled };
    ...
    this.init = function() {
		...
		try {
			...
			console.log("tooltips crashed " + e.toString());
		}
    };
    ...
    this.show = function(site, type, id, attach, element) {
        ...
        if (info === true) {
			...
			this.renderCallback(info, container.innerHTML, lastElement, function(newContent){
