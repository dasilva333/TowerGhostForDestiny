...
var initial_stat = amt - bonus;
var target_defense = 385;
var initial_defense = 335;
var newAmt = parseInt(initial_stat * ((target_defense + tgd.DestinyCornRatio) / (initial_defense + tgd.DestinyCornRatio))) + bonus;
return [type, newAmt];
}));*/
tgd.DestinyMaxCSP = {
    "Artifact": 148,
