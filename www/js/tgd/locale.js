tgd.locale = {
    en: {
        ...
        menu_sortby_tier_type: "Tier, Type, Light",
    ...
    de: {
        ...
        menu_sortby_tier_type: "Seltenheit, Typ, Licht",
    ...
    fr: {
        ...
        cancel: "Annuler",
        cannot_equip: "Erreur impossible d'équiper ",
        cannot_unequip: "Impossible. Il n'y a rien a équiper a la place ",
        close_msg: "Fermer",
        ok_msg: "OK",
        disc: "Disc",
        discipline: "Discipline",
        ...
        inventory_postmaster_messages: "Messages",
        inventory_subclasses: "Doctrines",
        inventory_weapons: "Armes",
        itemDefs_undefined: "S'il vous plaît signaler le problème sur mon Github et assurez-vous que votre police est l'anglais.",
        language_pack_downloaded: "Pack de langue téléchargé, s'il vous plaît rafraîchissez pour voir les changements",
        ...
        light: "Lumière",
        loadouts_alreadythere_pt1: " est déjà dans le ",
        loadouts_alreadythere_pt2: "est dans la fente de ",
        loadouts_delete: "Supprimer",
        loadouts_desktop: "Bureau",
        loadouts_instructions: "Aucun object dans le loadout, cliquez sur l'objet pour l'ajouer , ",
        loadouts_instructions_contd: " équiper.",
        loadouts_invalidbucket: " ne sera pas déplacé. À cause de cette fente: ",
        loadouts_mobile: "tenir",
        loadouts_no_replacement: " ne sera pas déplacé. Il n'y a aucun objet pour le remplacer.",
        loadouts_no_transfer: " ne sera pas déplacé",
        loadouts_outofspace: " ne sera pas déplacé, Il n'y a pas de place ",
        loadouts_save: "Enregistrer",
        loadouts_save_new: "Enregistrer comme nouveau",
        loadouts_swap: " sera remplacée par ",
        loadouts_to_equip: " sera équipé.",
        loadouts_to_moveequip: " sera déplacé et équipé.",
        loadouts_to_transfer: " sera déplacé",
        loadouts_transfer: "Transférer",
        loadouts_transfer_confirm: "Transféré Confirmer",
        loadouts_transferred: "<strong>Articles transféré avec succès</strong><br> Si vous aimez ce logiciel pensez à <a style=\"color:#3080CF; cursor:pointer;\" class=\"donateLink\" target=\"_system\">achetez-moi une bière</a>",
        login_authenticating_pt1: "Connexion à Bungie ... S'il vous plaît soyez patient.",
        login_authenticating_pt2: "Si cet écran de connexion reste + de 2 minutes, utiliser ces liens pour",
        login_authenticating_pt3: "pour réessayer de vous connexion. Si le problème persiste, réinstallez l'application.",
        login_help: "S'il vous plaît attendrez la fenêtre de connexion à proximité de l'automobile comme TGD prépare vos informations.",
        ...
        menu_about: "Propos",
        menu_advancedtooltips: "infobulles avancée",
        menu_view_by: "Voir de",
        menu_view_by_lightlvl: "Niveau de Lumière",
        menu_view_by_stat_points: "Points Stats combinés ",
        menu_all: "Tout",
        ...
        menu_destinyguardiangg: "Guardian.GG Report",
        menu_donate: "Don",
        menu_filter_by: "Filtrer de",
        menu_filter_by_subclass_eq: "Doctrine Équipée",
        menu_filter_by_weapon_eq: "Armes Équipée",
        menu_filter_for_class: "Filtrer par classe",
        menu_help: "Aide",
        menu_language: "Langues",
        menu_loadouts: "Loadouts",
        menu_loadouts_create: "Créer",
        menu_loadouts_manage: "Gérer",
        menu_padheight: "Hauteur du Pad auto.",
        menu_progress: "Progression",
        menu_progress_1: "Atouts Manquant ",
        menu_progress_2: "Bordure Manquant",
        menu_progress_3: "au maximum",
        menu_refresh: "Actualisez",
        menu_set: "Collection",
        ...
        menu_sortby_lightlvl: "Niveau de lumière",
        menu_sortby_name: "Nom",
        menu_sortby_type: "Type",
        menu_sortby_tier_type: "Palier, Type, Lumière",
        menu_sortby_tier_light: "Palier, Lumière",
        menu_sortby_tier_name: "Palier, Nom",
        menu_sortby_type_light: "Type, Lumière",
        menu_tier: "Rareté",
        menu_useps: "Utiliser un compte Playstation",
        menu_usexbox: "Utiliser un compte Xbox",
        menu_view: "Voir",
        ...
        movepopup_extras: "extras",
        movepopup_move: "Déplacer",
        movepopup_store: "transférer",
        movepopup_vault: "Coffre",
        normalize: "Normaliser",
        normalize_title: "Normaliser - distribuer également le thème à travers ses personnages",
        paypal_code: "FR",
        pick_a_set: "S'il vous plat choisez un ensemble avant de choisir cette option",
        ...
        tier_common: "Commun",
        tier_exotic: "Exotique",
        tier_legendary: "Legendaire",
        tier_rare: "Rare",
        tier_uncommon: "Peu commun",
        transfer: "Transférer",
        transfer_all: "Tous",
        transfer_amount: "montant du transfert",
        transfer_ask: "Ne demandez pas à l'avenir",
        consolidate: "Consolider",
        transfer_consolidate: "Consolider (retirer de tous les personnages)",
        transfer_one: "Un",
        unable_create_loadout_for_type: "Actuellement impossible de créer un loadouts avec ce type d'article",
        unable_to_create_loadout_for_bucket: "Vous ne pouvez pas crer un loadout avec plus de 10 articles dans cette fente: ",
        unable_to_move_bucketitems: "Impossible de transférer l'article avec l'application.",
        unable_unequip: "Impossible de retirer ",
        vo_container_width: "Largeur du contenu",
        vo_layout_mode: "Mode Présentation",
        vo_layout_mode_cust: "Personnalisé",
        vo_layout_mode_def: "Default",
        vo_number_of_columns: "Nombre de colonnes",
        vo_vault_columns: "Colonnes du coffres",
        vo_vault_first: "Première/Gauche",
