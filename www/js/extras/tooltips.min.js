...
window.$ZamTooltips = function() {
    ...
    var fetch = function(site, type, id) {
        ...
        //temp hack while DestinyDB is down, need to update manifest.json/meta-csp to include http and https for DestinyDb when it's down
        if (tgd.itemsNotIndexed.indexOf(parseFloat(id)) > -1 || 1 == 1) {
            fetchLocal(id);
        } else {
