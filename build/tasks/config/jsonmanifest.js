	...
	grunt.config.set('jsonmanifest',{
      generate: {
        ...
        src: [
			...
			'../www/js/locale.js',
			'../www/js/version.js',
			'../www/js/dependencies/cordova-app-loader-complete.js',
			'../www/js/dependencies/underscore-min.js',
			'../www/js/dependencies/jquery.js',
			'../www/js/dependencies/jquery-ui.js',
			'../www/js/dependencies/jquery-ui.touchpunch.js',
			'../www/js/dependencies/jquery.toaster.js',
			'../www/js/dependencies/bootstrap.js',
			'../www/js/dependencies/bootstrap-dialog.js',
			'../www/js/dependencies/knockout.js',
			'../www/js/dependencies/knockout-sortable.js',
			'../www/js/dependencies/hammer.js',
			'../www/js/dependencies/idle-timer.min.js',
			'../www/js/dependencies/fastclick.js',
			'../www/js/dependencies/analytics.js',
			'../www/js/firefox-xhr.js',
			'../www/js/loadouts.js',
			'../www/js/Profile.js',
			'../www/js/Item.js',
			'../www/js/app.js',
			'../www/js/ga.js',
			'../www/js/tooltips.min.js',
